...
<body>
    <?php include 'includes/header.php';?>
        <div class="container-fluid" id="banner_about">
            <div class="text-box">
                <h2 class="heading_white_h3">Home / Profile</h2> </div>
        </div>
                                    ...
                                    <div class="tabpanel">
                                              ...
                                              <div class="blog-card">
                                                  ...
                                                  <p class="report" data-toggle="modal" data-target="#report_modal"><i class="fa fa-flag" aria-hidden="true"></i> Report</p>
                                                    ...
                                                    <div class="col-md-4 col-xs-12">
                                                     ...
                                                     </h2> <a class="btn_read_more" data-toggle="modal" data-target="#spread_event_modal">Spread Event</a>
                                                            <a href="profile-know-more.php" class="btn_read_more">Know More </a>
                                                            <div class="space"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="tabpanel__panel" id="tabpanel__panel-3">
                                                <div class="tabpanel__panel-2">
                                                    <h2>Do You Want To Active</h2>
                                                
                                                <a class="btn_read_more">Yes</a>
                                                    <a class="btn_read_more">No</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
